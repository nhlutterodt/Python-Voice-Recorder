...
class TestDatabaseContextManager:
    ...
    def test_circuit_breaker_opening(self, context_manager):
        ...
        # Reach threshold
        context_manager._circuit_breaker_failures = (
            context_manager.config.circuit_breaker_threshold
        )
    ...
    def test_circuit_breaker_timeout_recovery(self, context_manager):
        ...
        context_manager._circuit_breaker_last_failure = time.time() - (
            context_manager.config.circuit_breaker_timeout + 1
        )
    ...
    def test_get_session_retry_exhaustion(self, mock_disk_usage, context_manager):
        ...
        context_manager.session_factory.side_effect = Exception(
...
class TestDatabaseExceptions:
    ...
    def test_database_circuit_breaker_error(self):
        ...
        error = DatabaseCircuitBreakerError(
    ...
    def test_database_connection_error(self):
        ...
        error = DatabaseConnectionError(
            "Failed to connect", original_error, retry_count=3
        )
    ...
    def test_database_timeout_error(self):
        ...
        error = DatabaseTimeoutError(
            "Operation timed out", timeout_seconds=30, operation="query"
        )
    ...
    def test_database_integrity_error(self):
        ...
        error = DatabaseIntegrityError(
            "Corruption detected",
            corruption_type="table",
            affected_tables=["recordings"],
        )
