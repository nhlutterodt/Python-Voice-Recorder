...
class TestStorageConstraints:
    ...
    def test_validate_file_constraints_approaching_limit(self):
        ...
        with patch('os.path.exists', return_value=True):
            with patch('os.path.getsize', return_value=int(800 * 1024 * 1024)):  # 800MB (80% of 1000MB)
                result = self.constraints.validate_file_constraints('/mock/large_file.txt')
    ...
    def test_validate_disk_space_for_file_sufficient_space(self, mock_collector_class):
        ...
        with tempfile.NamedTemporaryFile() as temp_file:
            ...
            result = self.constraints.validate_disk_space_for_file(temp_file.name, base_path)
...
class TestConstraintValidator:
    ...
    def test_validate_before_operation_oversized(self, mock_collector_class):
        ...
        result = self.validator.validate_before_operation('write', 1500.0, Path('/tmp'))  # Exceeds 1000MB limit
    ...
    def test_validate_before_operation_approaching_limit(self, mock_collector_class):
        ...
        result = self.validator.validate_before_operation('write', 850.0, Path('/tmp'))  # 85% of 1000MB limit
    ...
    def test_validate_before_operation_large_file_recommendations(self, mock_collector_class):
        ...
        result = self.validator.validate_before_operation('write', 150.0, Path('/tmp'))  # Large file
