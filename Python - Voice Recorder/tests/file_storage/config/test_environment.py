...
class TestEnvironmentConfig:
    ...
    def test_merge_with_custom_invalid_key(self):
        ...
        custom_config = {"invalid_key": "invalid_value"}
    ...
    def test_merge_with_custom_invalid_value(self):
        ...
        custom_config = {"min_disk_space_mb": -50}  # Invalid value
...
class TestEnvironmentManager:
    ...
    def test_get_config_with_custom_overrides(self):
        ...
        custom_config = {"min_disk_space_mb": 1000, "enable_backup": True}
    ...
    def test_get_environment_summary(self):
        ...
        assert summary["supported_environments"] == [
            "development",
            "testing",
            "production",
        ]
    ...
    def test_compare_environments(self):
        ...
        comparison = EnvironmentManager.compare_environments(
